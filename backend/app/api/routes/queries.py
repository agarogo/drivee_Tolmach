...
from app.api.common import ensure_query_chat, make_chat_title, query_to_out, require_owned_chat, require_owned_query
from app.auth import get_current_user
from app.db import get_db
from app.models import Chat, Message, Query, QueryClarification, User
...
async def query_history(
    ...
    rows = list((await db.scalars(select(Query).where(Query.user_id == user.id).order_by(Query.created_at.desc()).limit(limit))).all())
