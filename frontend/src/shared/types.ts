...
export type ControlledErrorCode = "llm_timeout" | "llm_unavailable";

export type ControlledQueryError = {
  status: ControlledErrorCode;
...
export type LlmErrorMessagePayload = ControlledQueryError & {
  type: "llm_error";
};
