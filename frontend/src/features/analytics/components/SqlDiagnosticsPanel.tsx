      ...
      {!!query.guardrail_logs.length && (
        <details className="detail-panel">
          <summary>
            ...
            <small>{query.guardrail_logs.length} записей</small>
          </summary>
